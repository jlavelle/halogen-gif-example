...
(function(exports) {
  ...
  var LoadGif = (function () {
      function LoadGif(value0) {
          this.value0 = value0;
      };
      LoadGif.create = function (value0) {
          return new LoadGif(value0);
      };
      return LoadGif;
  })();
  var UpdateTopic = (function () {
      function UpdateTopic(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      UpdateTopic.create = function (value0) {
          return function (value1) {
              return new UpdateTopic(value0, value1);
          };
      };
      return UpdateTopic;
  })();
  var decodeImageUrl = function (s) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeStrMap(Data_Argonaut_Decode_Class.decodeJsonJson))(s))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeStrMap(Data_Argonaut_Decode_Class.decodeJsonJson))(v)("data"))(function (v1) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v1)("image_url"))(function (v2) {
                  return Control_Applicative.pure(Data_Either.applicativeEither)(v2);
              });
          });
      });
  };
  var randomGifUrl = function (topic) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Functor.map(Control_Monad_Aff.functorAff)(function (v) {
          return v.response;
      })(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableString)("https://api.giphy.com/v1/gifs/random?api_key=dc6zaTOxFJmzC&tag=" + topic)))(function (v) {
          var url = Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Parser.jsonParser(v))(decodeImageUrl);
          return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(url);
      });
  };
  var ui = (function () {
      var render = function (st) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Halogen Gif Viewer!") ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Current topic: " + st.topic) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(UpdateTopic.create)), Halogen_HTML_Events.onKeyPress(function (k) {
              var $17 = DOM_Event_KeyboardEvent.key(k) === "Enter";
              if ($17) {
                  return Halogen_HTML_Events.input_(LoadGif.create)(Data_Unit.unit);
              };
              return Data_Maybe.Nothing.value;
          }), Halogen_HTML_Properties.value(st.topic) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(LoadGif.create)) ])([ Halogen_HTML_Core.text("Load Gif") ]) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src(st.gifUrl) ]) ]), (function () {
              if (st.loading) {
                  return Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Loading...") ]);
              };
              return Halogen_HTML_Elements.p_([  ]);
          })(), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(st.errorMessage) ]) ]);
      };
      var initialState = {
          loading: false,
          gifUrl: "",
      ...
      var $$eval = function (v) {
          if (v instanceof LoadGif) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(randomGifUrl(v1)))(function (v2) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                              ...
                              if (v2 instanceof Data_Either.Left) {
                                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                      ...
                                      $30.errorMessage = "No gif found for topic " + v1;
                                      $30.loading = false;
                                      return $30;
                                  });
                              };
                              throw new Error("Failed pattern match at GifViewer line 72, column 7 - line 74, column 107: " + [ v2.constructor.name ]);
                          })())(function () {
          ...
          throw new Error("Failed pattern match at GifViewer line 67, column 10 - line 78, column 16: " + [ v.constructor.name ]);
      };
      return Halogen_Component.lifecycleComponent(Halogen_HTML_Core.bifunctorHTML)({
          initialState: Data_Function["const"](initialState),
          render: render,
          "eval": $$eval,
          initializer: new Data_Maybe.Just(Halogen_Query.action(LoadGif.create)),
  ...
  exports["ui"] = ui;
  exports["randomGifUrl"] = randomGifUrl;
  exports["decodeImageUrl"] = decodeImageUrl;
})(PS["GifViewer"] = PS["GifViewer"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(GifViewer.ui)(Data_Unit.unit)(v);
  }));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
